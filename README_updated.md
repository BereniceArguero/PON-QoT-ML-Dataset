...
If you use this dataset, code, or results in academic work, please cite this repository.

The repository includes a `CITATION.cff` file so GitHub can provide a **Cite this repository** option.
...
When using the dataset in academic work, please provide appropriate attribution and cite the repository or the associated publication.
